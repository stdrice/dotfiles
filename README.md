...
# **Starring 🌠**
<img src="https://i.imgur.com/mYsKmXD.png" align="right" width="400px">
...
```
brightnessctl btop calcurse dunst foot gammastep mpc mpd mpd-mpris ncmpcpp neofetch noto-fonts playerctl power-profiles-daemon rofi slurp sway swaybg swayidle swaylock-effects ttf-meslo-nerd ttf-nerd-fonts-symbols ttf-roboto waybar zsh
```
- Clone this repo
...
| Floating                                 | Tiling                                     |
| :--------------------------------------- | :----------------------------------------- |
| ![busy](https://i.imgur.com/mYsKmXD.png) | ![tiling](https://i.imgur.com/atC5dGA.png) |
| Launcher                                 | Lockscreen                                 |
| ![rofi](https://i.imgur.com/sh4T84I.png) | ![lock](https://i.imgur.com/zTXJuft.png)   |
