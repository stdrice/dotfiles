...
```
bash brightnessctl btop calcurse dunst foot gammastep imagemagick inter-font mpc mpd mpd-mpris ncmpcpp neofetch papirus-icon-theme playerctl power-profiles-daemon rofi slurp swaybg swayfx swayidle swaylock-effects swaync wireplumber ttf-nerd-fonts-symbols waybar zsh
```
- Clone this repo
